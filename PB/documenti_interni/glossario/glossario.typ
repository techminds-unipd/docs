...
#show: documento.with(
  ...
  changelog: (
    "1.4.0", "25/03/2025", "Aggiunta definizione local storage", team.T, "",
...
== Local storage
Spazio di archiviazione sul browser che permette di memorizzare oggetti Javascript lato client. È simile ad un cookie ma con una capacità maggiore. Ogni sito ha uno spazio di archiviazione isolato dagli altri.
