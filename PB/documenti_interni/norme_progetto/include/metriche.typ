...
Per definire le metriche e i criteri che determinano la qualità del software sviluppato dal gruppo, abbiamo deciso di seguire lo standard ISO/IEC 9126. Questo standard definisce un modello di qualità del software in sei caratteristiche generali:
