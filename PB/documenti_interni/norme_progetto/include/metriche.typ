...
=== Efficienza 
è la capacità di fornire appropriate prestazioni relativamente alla quantità di risorse usate dal sistema. Anch'essa è un "requisito non funzionale" o "requisito di qualità". I principali sottoattributi sono:
...
=== Portabilità
Capacità del software di essere trasportato da un ambiente di lavoro ad un altro (ambiente che può variare dall'hardware al sistema operativo). Questa è anch'essa considerata un "requisito non funzionale" o "requisito di qualità". I principali sottoattributi sono:
