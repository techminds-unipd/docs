...
#show: verbale.with(
  title: "Verbale esterno del 31/03/2025",
  ...
  riassunto: [
    Riunione finale con il proponente, anticipata da venerdì 04/04/2025 a martedì 31/03/2025. Lo scopo di questo incontro è stato mostrare il prodotto finale e verificare che ogni test di accettazione fosse soddisfatto. Congiuntamente alla discussione sul superamento dei test di accettazione, il proponente ha avuto la possibilità di visionare il prodotto finale (Agent Flow), reputandolo un lavoro buono rispetto alle attese. Sono stati poi superati tutti i test di accettazione definiti nel #link("https://techminds-unipd.github.io/docs/PB/documenti_esterni/piano_qualifica/piano-di-qualifica.pdf")[piano di qualifica]#footnote(link("https://techminds-unipd.github.io/docs/PB/documenti_esterni/piano_qualifica/piano-di-qualifica.pdf")) [versione 1.11.0].
  ],
  decisioni: (
