...
- *Nuove conoscenze*: il gruppo ha appreso nuove tecnologie e metodologie di lavoro, come ad esempio l'uso di GitHub per la gestione del codice sorgente, il versionamento e il sistema di ticketing oppure l'uso di #glossario[Docker] per la creazione di ambienti di sviluppo e produzione. Il gruppo ha anche appreso come utilizzare le tecniche di test e #glossario[verifica] del software, come i #glossario[test di unità], i #glossario[test di integrazione] e i #glossario[test di sistema].
