...
#figure(
  table(
    ...
    ..getMPROCByProcess("fornitura", false, false, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("sviluppo", false, false, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("documentazione", false, false, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("verifica", false, false, true).flatten()
  ), 
...
#figure(
  ...
  ..getMPROCByProcess("gestione rischi", false, false, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("gestione qualità", false, false, true).flatten()
  ), 
