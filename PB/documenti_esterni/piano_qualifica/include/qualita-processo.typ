...
#figure(
  table(
    ...
    ..getMPROCByProcess("fornitura", false, false, true, true).flatten()
  ), 
...
==== Sviluppo
Il processo di sviluppo si occupa del controllo e della gestione di tutte le fasi del ciclo di vita del prodotto software.
#set par(justify: false)
#figure(
  table(
    columns: (0.65fr, 1.1fr, 0.9fr, 0.75fr),
    ...
    ..getMPROCByProcess("sviluppo", false, false, true, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("documentazione", false, false, true, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("verifica", false, false, true, true).flatten()
  ), 
...
#figure(
  ...
  ..getMPROCByProcess("gestione rischi", false, false, true, true).flatten()
  ), 
...
#figure(
  table(
    ...
    ..getMPROCByProcess("gestione qualità", false, false, true, true).flatten()
  ), 
