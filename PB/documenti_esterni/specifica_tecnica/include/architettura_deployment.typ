...
L'architettura di deployment è composta da quattro componenti principali: il frontend, il backend, l'agente e il database.
#figure(
  image("../assets/architettura-deployment.svg", width: 75%),
