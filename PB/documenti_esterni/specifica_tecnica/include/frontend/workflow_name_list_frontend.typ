...
La classe contiente un unico metodo, #declaration("allWorkflows(accessToken: string): string*"), che effettua una chiamata all'endpoint API corrispondente e gestisce i diversi casi di risposta:
