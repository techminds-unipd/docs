...
- *Conditional Rendering*: permette di mostrare contenuti diversi in base alla verità di una condizione specificata. Alcuni componenti lo sfruttano per visualizzare i dati in base all'autenticazione dell'utente.
