...
- *Decorator*: implementato da _NestJS_ per aggiungere metadati a classi, metodi e proprietà. I decorator vengono inoltre utilizzati per definire i vari componenti dell'applicazione, come i moduli e i controller, inclusi i vari endpoint delle API REST;
