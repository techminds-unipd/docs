...
Le nostre comunicazioni avvengono attraverso vari canali.
Utilizziamo telegram per le comunicazioni veloci e per effettuare il daily stand-up meeting tramite messaggi.
Il gruppo telegram è diviso in sezioni:
1. General, per le comunicazioni varie;
2. Daily scrum, per il daily stand-up meeting.
Il daily stand-up meeting ha una forma precisa, il messaggio deve contenere le seguenti informazioni in questo ordine:
...
+ General, per comunicazioni varie;
...
=== Sprint e Milestone
Visto che utilizziamo la metodologia Agile le nostre attività saranno divise in periodi di lunghezza 2-3 settimane (circa) chiamati sprint.
Poi suddividiamo l'intera durata del progetto in milestone, che rappresentano un progresso significativo.
