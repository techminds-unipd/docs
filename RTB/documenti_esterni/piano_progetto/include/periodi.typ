...
==== Pianificazione
Data la scarsa conoscenza del dominio, il primo sprint avrà una durata maggiore rispetto a quelli successivi e verrà dedicato allo studio delle tecnologie necessarie per lo sviluppo del progetto. In accordo con il proponente, abbiamo deciso quindi di dare maggior priorità all'autoformazione sulle nuove tecnologie. Sono anche stati concordati dei corsi di formazione in presenza con l'azienda, nelle date 26/11/2024 e 28/11/2024, e un ulteriore corso a distanza il giorno 03/12/2024. Il tempo rimanente verrà poi dedicato alla stesura di una parte del documento di #glossario[analisi dei requisiti]. Inoltre andremo ad aggiornare il piano di progetto, in particolare la sezione “Analisi dei rischi”, e il documento riguardante le norme di progetto.\
...
#list(
    ...
    [verrà creata una checklist con i vari controlli da svolgere nei documenti per agevolare le attività dei verificatori, dal momento che la #glossario[verifica] è risultata essere molto onerosa per le tante convenzioni interne adottate;],
