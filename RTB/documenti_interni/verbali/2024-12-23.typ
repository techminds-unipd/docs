...
#show: verbale.with(
  ...
  changelog: (
    "1.0.0", "09/12/2024", "Prima versione", team.A,".-.-."
  ),
  ...
  riassunto: [Ci siamo riuniti per celebrare la sprint retrospective dello sprint 2, successivamente abbiamo celebrato lo sprint plan dello sprint 3.
            ...
            - lo studio delle tecnologie è stato completato da tutti i componenti del gruppo.#linebreak()
           Successivamente abbiamo celebrato lo sprint plan dello sprint 3, che avrà la durata di tre settimane, vista la minore disponibilità dei componenti del gruppo causa festività natalizie.
