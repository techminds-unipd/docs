...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        # Blacklist
        blacklist = ["template/", "candidatura/", "/verbali/", "/costi.typ", "/piano-di-progetto.typ", "/use_cases.typ", "/qualita-processo.typ",  "/piano-di-qualifica.typ", "/analisi-dei-requisiti.typ", "/requisiti.typ", "/controllo-metriche.typ", "/norme-di-progetto.typ"]
