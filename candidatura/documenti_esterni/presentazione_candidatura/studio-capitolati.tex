...
\subsubsection{Contatti avuti con l'azienda}
Il gruppo ha richiesto un colloquio informativo da remoto, su piattaforma Google Meet. Il verbale relativo all'incontro del 18/10/2024 è presente nell'omonima cartella nella repository\footnote{\url{https://github.com/techminds-unipd/docs/blob/main/candidatura/documenti_esterni/verbali/2024-10-18/2024-10-18-Firmato.pdf}}.
\subsubsection{Conclusione}
